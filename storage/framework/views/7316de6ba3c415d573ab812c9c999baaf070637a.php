            ...
            <form method="POST" action="<?php echo e(route("admin.work-order.update", $workOrder->id)); ?>"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control <?php echo e($errors->has('title') ? 'is-invalid' : ''); ?>" type="text" name="title"
                           id="title" value="<?php echo e($workOrder->title); ?>" required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control <?php echo e($errors->has('description') ? 'is-invalid' : ''); ?>"
                              name="description"
                              id="description" required><?php echo e($workOrder->description); ?> </textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/whoami/Sites/portalenesis/resources/views/admin/work-order/list-wo/edit.blade.php ENDPATH**/ ?>