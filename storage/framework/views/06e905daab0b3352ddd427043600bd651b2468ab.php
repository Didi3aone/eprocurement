...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form class="form-material m-t-40" method="POST" action="<?php echo e(route("admin.roles.update", [$role->id])); ?>" enctype="multipart/form-data">
                    <?php echo method_field('PUT'); ?>
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
                        <label><?php echo e(trans('cruds.role.fields.title')); ?></label>
                        <input type="text" class="form-control form-control-line <?php echo e($errors->has('title') ? 'is-invalid' : ''); ?>" name="title" value="<?php echo e(old('title', $role->title)); ?>"> 
                    ...
                    <div class="form-group">
                        <label><?php echo e(trans('cruds.role.fields.permissions')); ?></label>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="<?php echo e(route('admin.roles.index')); ?>" type="button" class="btn btn-inverse">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/whoami/Sites/eprocurement/resources/views/admin/roles/edit.blade.php ENDPATH**/ ?>