<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <?php echo e(trans('global.edit')); ?> <?php echo e(trans('cruds.work-order.fields.module')); ?>

        </div>

        <div class="card-body">
            <form method="POST" action="<?php echo e(route("admin.work-order-module.update", $workOrderModule->id)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('put'); ?>
                <div class="form-group">
                    <label class="required" for="name"><?php echo e(trans('cruds.work-order.fields.module')); ?></label>
                    <input class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>" type="text" name="name" id="name" value="<?php echo e($workOrderModule->name ?? old('name', '')); ?>" required>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 <?php echo e($errors->has('departmentId') ? 'is-invalid' : ''); ?>" name="departmentId" id="departmentId" required>
                        <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $departments): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>" <?php echo e($workOrderModule->departmentId === $id ? 'selected' : in_array($id, old('departmentId', []))  ? 'selected' : ''); ?>><?php echo e($departments .' - '. $id); ?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="">
                        <div class="form-check form-check-inline mr-1">
                            <input class="form-check-input" id="inline-radio-active" type="radio" value="1" name="status"  <?php if($workOrderModule->status === 1): ?> checked <?php endif; ?>>
                            <label class="form-check-label" for="inline-radio-active">Active</label>
                        </div>
                        <div class="form-check form-check-inline mr-1">
                            <input class="form-check-input" id="inline-radio-non-active" type="radio" value="0" name="status" <?php if($workOrderModule->status === 0): ?> checked <?php endif; ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/whoami/Sites/portalenesis/resources/views/admin/work-order/module/edit.blade.php ENDPATH**/ ?>