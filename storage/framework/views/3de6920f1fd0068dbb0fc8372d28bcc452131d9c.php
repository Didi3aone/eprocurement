...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Form Create Department</h4>
                <form class="form-material m-t-40" action="<?php echo e(route("admin.department.store")); ?>" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-line <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>" name="name" value="<?php echo e(old('name', '')); ?>"> 
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 <?php echo e($errors->has('company_id') ? 'is-invalid' : ''); ?>" name="company_id" id="company_id" required>
                            <?php $__currentLoopData = $company; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $cmp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cmp->id); ?>" <?php echo e(in_array($cmp->id, old('company_id', [])) ? 'selected' : ''); ?>><?php echo e($cmp->name); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 <?php echo e($errors->has('category_id') ? 'is-invalid' : ''); ?>" name="category_id" id="category_id" required>
                            <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cat->id); ?>" <?php echo e(in_array($cat->id, old('category_id', [])) ? 'selected' : ''); ?>><?php echo e($cat->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/whoami/Sites/eprocurement/resources/views/admin/department/create.blade.php ENDPATH**/ ?>