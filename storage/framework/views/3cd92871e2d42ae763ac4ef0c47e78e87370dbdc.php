<?php $__env->startSection('content'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('work_order_module_create')): ?>
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="<?php echo e(route("admin.work-order-module.create")); ?>">
                    <?php echo e(trans('global.add')); ?> <?php echo e(trans('cruds.work-order.fields.module')); ?>
                            ...
                            <td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('work_order_module_show')): ?>
                                    <a class="btn btn-xs btn-primary"
                                       href="<?php echo e(url("admin/work-order-module/$workOrderModule->id/sub-module")); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('work_order_module_edit')): ?>
                                    <a class="btn btn-xs btn-info"
                                       href="<?php echo e(route('admin.work-order-module.edit', $workOrderModule->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('work_order_module_delete')): ?>
                                    <form action="<?php echo e(route('admin.work-order-module.destroy', $workOrderModule->id)); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/whoami/Sites/portalenesis/resources/views/admin/work-order/module/index.blade.php ENDPATH**/ ?>