    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach ($result as $key => $val) {
                ...
                if (null != $cMo) {
                    if ('S03' == $cMo->purchasing_group_code ||
                        'H09' == $cMo->purchasing_group_code ||
                        'M09' == $cMo->purchasing_group_code ||
                        'W03' == $cMo->purchasing_group_code ||
                        'S09' == $cMo->purchasing_group_code ||
                        'W09' == $cMo->purchasing_group_code ||
                        'M03' == $cMo->purchasing_group_code) {
                        $isCmo = true;
                    }
                } else {
