...
class QuotationController extends Controller
{
    ...
    private function _send_sap_po_repeat($id) 
    {
        ...
        $this->_approval_po_repeat($id, $PO_NUMBER);
    }

    private function _approval_po_repeat($id, $PO_NUMBER)
    {
        // quotation approve
        $q_update = Quotation::where('id', $id)->update(['approval_status' => 2]);
    ...
    public function repeat_approve (Request $request, $ids)
    {
        ...
        try {
            ...
            \DB::rollBack();
            return redirect()->route('admin.quotation.repeat');
        }
    }
