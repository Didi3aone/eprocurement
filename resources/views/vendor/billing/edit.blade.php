                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <select class="form-control select2" name="ppn" id="ppn" placeholder="Choose">
                                        ...
                                        <option value="V0" @if($billing->ppn == 'V0') selected @endif> None </option>
                                        <option value="V1" @if($billing->ppn == 'V1') selected @endif> PPN </option>
                                    </select>
                                    @if($errors->has('ppn'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('ppn') }}
                                    ...
                                    <label>Account No <span class="text-danger">*</span></label>
                                     <select class="form-control select2" name="no_rekening" id="no_rekening" placeholder="Choose">
                                        ...
                                        @foreach($rekening as $id => $account_no )
                                            <option value=" {{ $account_no }} " @if($billing->no_rekening == $account_no) selected @endif>{{ $account_no }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-lg-12 table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody id="billing-detail">
                                            ...
                                            <tr>
                                                <input type="hidden" name="idDetails[]" value="{{ $value->id }}">
                                                <input type="hidden" name="po_no[]" value="{{ $value->po_no }}">
                                                <td><input type="number" class="qty-old form-control" name="qty_old[]" value="{{ $value->qty_old }}" readonly></td>
                                                <td><input type="number" class="qty form-control" name="qty[]" value="{{ $value->qty }}" required/></td>
                                                <td><input type="text" class="material form-control" name="material[]" value="{{ $value->material_id }}" readonly></select></td>
                                                <td><input type="text" class="description form-control" name="description[]" value="{{ $value->description }}" readonly/></td>
                                                <td><input type="text" class="po_no form-control" name="po_no[]" value="{{ $value->po_no }}" readonly></td>
                                                <td><input type="text" class="po_item form-control" name="PO_ITEM[]" value="{{ $value->PO_ITEM }}" readonly/></td>
                                                <td><input type="text" class="doc_gr form-control" name="doc_gr[]" value="{{ $value->doc_gr }}" readonly/></td>
                                                <td><input type="text" class="item_gr form-control" name="item_gr[]" value="{{ $value->item_gr }}" readonly/></td>
                                                <td><input type="text" class="posting_date form-control" name="posting_date[]" value="{{ $value->posting_date }}" readonly/></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
