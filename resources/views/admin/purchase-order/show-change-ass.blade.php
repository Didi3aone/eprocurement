...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form action="{{ route('admin.purchase-order-approval-change-ass') }}" method="POST">
                @csrf
                @method('put')
...
@parent 
    ...
    $(".submits").click(function() {
        ...
        $.ajax({
            type: "PUT",
            url: "{{ route('admin.purchase-order-approval-change-ass') }}",
            headers: {
           ...
           // dataType:'json',
            success: function (data) {
                //location.reload()
                location.href = '{{ route('admin.purchase-order-change-ass') }}'
            }
        });
    })
</script>
