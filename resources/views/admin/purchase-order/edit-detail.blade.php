...
<div class="row">
    <div class="col-12">
        <form class="form-material m-t-40" method="POST" action="{{ route("admin.purchase-order-detail.update", [$poDetail->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="card">
                <div class="card-body">
                        ...
                        <table id="datatables-run" class="table table-condesed">
                            ...
                            <tbody id="poItem">
                                ...
                                <tr id="item_{{ $value->id }}">
                                    ...
                                    <td>
                                        <input type="checkbox" class="" id="checks_{{ $value->id }}" name="delivery_complete[]" value="1">
                                        <label for="checks_{{ $value->id }}">&nbsp;</label>
                                    </td>
                                    <td>
                                        <a href="javascript:;" data-key="{{ $value->id }}" data-id="{{ $value->id }}"  class="remove-item btn btn-danger btn-xs">
