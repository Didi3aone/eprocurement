        ...
        <div class="row" style="margin-top: 20px">
            <div class="col-lg-12">
                <div class="form-actions">
                    <a href="#" class="btn btn-success approve" id="save" onclick="approve('{{ $quotation->id }}')" id="save"> <i class="fa fa-check"></i> Approve</a>
...
<script>
    ...
    {
        let idss = btoa(id) 
        $('.approve').attr('href', '{{ url("admin/quotation/repeat/approve/ass/") }}/' + idss)
    }
    ...
    $(".submits").click(function() {
        ...
        $.ajax({
            type: "PUT",
            url: "{{ route('admin.quotation-repeat-rejected') }}",
            headers: {
           ...
           // dataType:'json',
            success: function (data) {
                //location.reload()
                location.href = '{{ route('admin.quotation-repeat-approval-ass') }}'
            }
        });
    })
</script>
