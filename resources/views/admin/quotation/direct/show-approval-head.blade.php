...
<script>
    ...
    {
        let idss = btoa(id) 
        $('.approve').attr('href', '{{ url("admin/quotation/direct/approve/head/") }}/' + idss)
    }
    ...
    $(".submits").click(function() {
        ...
        $.ajax({
            type: "PUT",
            url: "{{ route('admin.quotation-direct-rejected-head') }}",
            headers: {
           ...
           // dataType:'json',
            success: function (data) {
                //location.reload()
                location.href = '{{ route('admin.quotation-direct-approval-head') }}'
            }
        });
    })
</script>
