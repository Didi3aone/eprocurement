            ...
            <div class="card-body">
                <form class="form-material m-t-40" action="{{ route("admin.rfq.store") }}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-line select2" name="purchasing_doc_type"> 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-line {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" value="A"> 
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-line select2" name="vendor">
                            @foreach ($vendors as $vendor)
                                <option value="{{ $vendor->code }}">{{ $vendor->code }} - {{ $vendor->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-line {{ $errors->has('language_key') ? 'is-invalid' : '' }}" name="language_key" value="EN"> 
                    ...
                    <div class="form-group">
                        <label>{{ trans('cruds.rfq-detail.fields.purchasing_organization_default') }}</label>
                        <input type="text" class="form-control form-control-line {{ $errors->has('purchasing_organization_default') ? 'is-invalid' : '' }}" name="purchasing_organization_default" value="0000"> 
                        @if($errors->has('purchasing_organization_default'))
                            <div class="invalid-feedback">
                                {{ $errors->first('purchasing_organization_default') }}
                            </div>
                        @endif
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>{{ trans('cruds.rfq-detail.fields.fixed_exchange_rate') }}</label>
                        <input type="text" class="form-control form-control-line {{ $errors->has('fixed_exchange_rate') ? 'is-invalid' : '' }}" name="fixed_exchange_rate" value=""> 
                        @if($errors->has('fixed_exchange_rate'))
                            <div class="invalid-feedback">
                                {{ $errors->first('fixed_exchange_rate') }}
                            </div>
                        @endif
                    </div>
                    <div class="form-group">
