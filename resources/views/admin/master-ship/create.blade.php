...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form class="form-material m-t-40" action="{{ route("admin.ship-to.store") }}" enctype="multipart/form-data" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        <label>Address</label>
                        <input type="text" class="form-control form-control-line {{ $errors->has('alamat') ? 'is-invalid' : '' }}" name="alamat" value="{{ old('alamat', '') }}"> 
